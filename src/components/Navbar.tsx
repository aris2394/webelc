          ...
          >
            ...
            {tentangKamiOpen && (
              <div className="absolute top-full left-0 mt-0 bg-white rounded-lg shadow-xl py-2 min-w-[180px] border border-gray-100 z-50">
                <Link href="/visi-misi" className="block px-4 py-2.5 text-[#293C88] font-poppins text-sm hover:bg-[#FFF4BA] transition-colors">Visi & Misi</Link>
      ...
      {mobileMenuOpen && (
        <div className="md:hidden border-t border-gray-100 bg-white">
          <div className="px-4 py-4 flex flex-col gap-2 shadow-lg pb-6">
            ...
            <div>
              ...
              {mobileTentangKamiOpen && (
                <div className="pl-8 flex flex-col py-1 bg-gray-50/50">
                  <Link href="/visi-misi" onClick={() => setMobileMenuOpen(false)} className="py-2.5 text-[#293C88] font-poppins text-sm border-l-2 border-[#FED700] pl-4">Visi & Misi</Link>
            ...
            <Link href="/kurikulum" onClick={() => setMobileMenuOpen(false)} className="px-4 py-3 text-[#293C88] font-poppins font-medium rounded hover:bg-gray-50">Kurikulum</Link>
            <Link href="/kontak" onClick={() => setMobileMenuOpen(false)} className="px-4 py-3 text-[#293C88] font-poppins font-medium rounded hover:bg-gray-50">Kontak</Link>
            <Link href="/artikel" onClick={() => setMobileMenuOpen(false)} className="px-4 py-3 text-[#293C88] font-poppins font-medium rounded hover:bg-gray-50">Artikel</Link>
          </div>
        </div>
      )}
    </div>
